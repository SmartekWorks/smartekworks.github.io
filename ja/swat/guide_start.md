...
スマーテックワークスでは、SWATクラウドサービスとSWATオンプレミス版を提供しています。

SWATオンプレミス版を使用する場合、最初にプライベートサーバーへSWATのオンプレミス版をセットアップする必要があります。SWATのオンプレミス版のセットアップ方法については、[SWATサーバーのセットアップ](setup_swat.md)を参照してください。
