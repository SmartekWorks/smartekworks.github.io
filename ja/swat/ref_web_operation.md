...
`Text`の場合、通常の入力文字列以外に、`#{KEY}`の形で、特殊キーを入れることも可能です。現在サポートしているKEYは`DOWN`、`LEFT`、`RIGHT`、`UP`、`TAB`、`ENTER`、`ESCAPE`、`BACK`です。
...
アラートの対応方法は[アラート対応](article_ajax.md#アラート対応)を参照ください。
