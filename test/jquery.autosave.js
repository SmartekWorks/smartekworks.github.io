...
;(function($) {
	...
	$.fn.autosave.go = function () {
		...
		$.cookie('autosave_'+u+'_check', cookiecheck, { expires: $.fn.autosave.options.cookieExpiryLength });
		...
		$.cookie('autosave_'+u+'_radio', cookieradio, { expires: $.fn.autosave.options.cookieExpiryLength });
	...
	$.fn.autosave.restore = function () {
		...
		if ($.cookie('autosave_'+u+'_check') != null) {
		...
		if ($.cookie('autosave_'+u+'_radio') != null) {
